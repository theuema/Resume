...
\section{Working Experience}
	...
	\sheader{Aug 2018 – Mai 2019 | Graz, Austria}
...
% --------------------------------------------------------------
	\section{Recent Experience} 
		...
		\sheader{2019/20: IT Security \& Security Aspects in Software Development}
		The main focus of \textit{IT Security} was to implement the TLS protocol with a pre-shared key handshake and Ascon and AES-GCM as authenticated encryption schemes with all its primitives, where we learned the importance of random number generators when generating a cryptographic key as well as basic key management techniques. Our implementation had to provide privacy, data integrity, and authenticity between two communicating parties. Additionally, we implemented our own blockchain based secure crypto currency. \\\smallsep
		\textit{Security Aspects in Software Development} gives insights into the ability to recognize and classify bugs, (efficiently) find bugs, exploit bugs, fix bugs, and prevent bugs in the first place. We studied and exploited  various memory corruption vulnerabilities including countermeasures, learned how to use different analysis, sanitizers or fuzzing to find bugs and how to prevent these performing defensive programming in C and C++. 
		\sectionsep
	
		\sheader{2019/20: Machine Learning \& Neural Networks}
		Both lectures, that also included practicals, are part of my major catalog.\\
		In \textit{Machine Learning} we learned about the basic theory of inference and decision, information theory, probability and distributions. We acquired understanding in the field of convex optimization problems, linear models for regression and classification as well as Kernel Methods up to our last assignment that required to implement a Support Vector Machine. \\\smallsep
		\textit{Neural Networks} discussed Feed-forward, Convolutional and Recurrent Neural Networks, weight-space symmetries, network training, error backpropagation, various training algorithms and regularization in Neural Networks. We most commonly used Tensorflow and Keras for our assignments. 
		\sectionsep
