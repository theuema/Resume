...
\section{Education} 
	\subsection{University of Technology}
		\descript{BS in Software Development}
	...
	\subsection{WIMO}
		\descript{Berufsreifeprüfung}
		\sheader{Klagenfurt, Austria}
		Qualification to attend university \\ 
		Grad. Jul 2014
	\sectionsep
...
% --------------------------------------------------------------
	...
	\sheader{Sep 2012 – Aug 2014 | Fremont, CA \& Villach, Austria}
	%\vspace{\topsep} % Hacky fix for awkward extra vertical space
	\begin{tightemize}
...
% --------------------------------------------------------------
	...
	\sheader{May 2010 – Sep 2012 | Villach, Austria}
	\begin{tightemize}
...
% --------------------------------------------------------------
	...
	\descript{| Engineer \& Quality Assurance Engineer}
	\sheader{Sep 2006 – Apr 2010 | Villach, Austria}
	\begin{tightemize}
		
	\item Basically: acquired the basics for further challenges within this company. 
	\item Worked as temporary worker.
...
\section{Interests} 
	...
	embedded systems \textbullet{} OS containers\\
